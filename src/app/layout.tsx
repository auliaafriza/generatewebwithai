...
export const metadata: Metadata = {
  title: {
    default: 'Website Generator With AI',
    template: '%s | Website Generator With AI',
  },
  description:
    'Demo website of generator with ai boilerplate. Built using Next.js, Tailwind CSS, Drizzle ORM, and PostgreSQL.',
};
